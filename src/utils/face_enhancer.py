...
def enhancer_list(images, method='gfpgan', bg_upsampler='realesrgan', restorer=None):
    gen = enhancer_generator_no_len(images, method=method, bg_upsampler=bg_upsampler, restorer=restorer)
    return list(gen)

def enhancer_generator_with_len(images, method='gfpgan', bg_upsampler='realesrgan', restorer=None):
